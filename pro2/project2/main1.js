...
function getTaskFromStorage(){
  let retrivedTask=JSON.parse(localStorage.getItem("taskse")) ;
  taskse= retrivedTask ?? []
...
function storeTask(){
  let taskString=JSON.stringify(taskse);
  localStorage.setItem("taskse",taskString)
}
